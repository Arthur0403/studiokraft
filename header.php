...
<head>
    ...
    <meta name="theme-color" content="<?php echo get_theme_mod( 'studiokraft_header_background_color' );?>">
    <?php wp_head(); ?>
    ...
    <noscript><div><img src="https://mc.yandex.ru/watch/65559973" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
</head>
