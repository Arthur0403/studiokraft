    ...
    <div class="header_top_w3ls">
        ...
        <div class="logo-wthree text-center logo-wthree__top">
            <a class="navbar-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>">
                <?php if( TRUE === get_theme_mod( 'studiokraft_show_logo' ) ) : ?>
