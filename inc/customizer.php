...
function studiokraft_customize_css()
{
    ...
    <style type="text/css">
        ...
        .navbar-light .navbar-nav .show>a,.navbar-light .navbar-nav .current-menu-item>a,.navbar-light .navbar-nav .menu-item>a:hover,.navbar-light .navbar-nav .menu-item>a:focus,.header_top a:hover span,.header_top a:focus span,.info .phone a:hover .studiokraft-phone,.info .phone a:focus .studiokraft-phone,.info .mail a:hover .studiokraft-mail,.info .mail a:focus .studiokraft-mail{color:<?php echo get_theme_mod( 'studiokraft_accent2_color' );?>;}
        .navbar-light .navbar-nav .menu-item>a:hover::before,.navbar-light .navbar-nav .menu-item>a:focus::before,.navbar-light .navbar-nav .current-menu-item>a::before{background-color:<?php echo get_theme_mod( 'studiokraft_accent2_color' );?>;}
