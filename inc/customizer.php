...
function studiokraft_customize_css()
{
    ...
    <style type="text/css">
        ...
        .header_top.mmove{background-color:<?php echo get_theme_mod( 'studiokraft_header_background_color' );?>ee;}
        ...
        header ul.social-icons a:hover, header ul.social-icons a:focus{ text-shadow:0px 0px 10px <?php echo get_theme_mod( 'studiokraft_accent2_color' );?> !important;}
